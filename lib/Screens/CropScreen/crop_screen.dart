...
class _CropScreenState extends State<CropScreen> {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: GestureDetector(
            ...
            child: Container(
              padding:  EdgeInsets.only(left: 25, top: 8, bottom: 8, right: 4),
              child: Icon(Icons.clear_sharp, color: Colors.white,),
            ),
          ),
          centerTitle: true,
          title: Text(
                ...
                if (cropLoader == false) {
                  ...
                  if (memoryImage != null) {
                    ...
                    if(compressedFile == null)
                      ...
                      {
                        Navigator.of(context).pop(compressedFile.path);
                      }
                  }
  ...
  Future<String> printImageSize(File file) async {
  ...
  Future<File?> compressImage(File file) async {
    ...
    var old = await printImageSize(file);
    print("before compression image $old");
    ...
    var newData = await printImageSize(File(compressedXFile?.path ?? ""));
    print("after compression image $newData");
